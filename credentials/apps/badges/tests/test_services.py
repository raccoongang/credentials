...
class IdentifyEventUserTestCase(TestCase):
    def setUp(self):
        ...
        self.user1 = UserCredential.objects.create(
            credential_content_type=self.content_type, credential_id=self.badge_template.id, username="testuser1",
        )
        self.user2 = UserCredential.objects.create(
            credential_content_type=self.content_type, credential_id=self.badge_template.id, username="testuser2",
        )
        self.user3 = UserCredential.objects.create(
            credential_content_type=self.content_type, credential_id=self.badge_template.id, username="testuser3",
        )
